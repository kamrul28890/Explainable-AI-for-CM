...
SEED = 42
# Multi-seed set for the scale run (Scale-up Phase 3.2): sample selection and
# stochastic steps should be repeated across these seeds and reported as
# mean +/- CI rather than a single SEED=42 point.
